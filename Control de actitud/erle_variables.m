...
erle.p_des_plot =   [0:erle.Tm:erle.T_simulacion];
...
erle.q_des_plot =   [0:erle.Tm:erle.T_simulacion];
...
erle.r_des_plot =   [0:erle.Tm:erle.T_simulacion];

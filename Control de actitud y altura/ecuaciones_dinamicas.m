...
global erle;
    ...
    erle.X_dd = (-(cos(erle.roll)*cos(erle.yaw)*sin(erle.pitch) + sin(erle.roll)*sin(erle.yaw))*erle.U1)/erle.m; 
    erle.Y_dd = (-(cos(erle.roll)*sin(erle.yaw)*sin(erle.pitch) - sin(erle.roll)*cos(erle.yaw))*erle.U1)/erle.m;
...
erle.Y_d_ = erle.Y_dd * erle.Tm + erle.Y_d;

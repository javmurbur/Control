...
set(erle.Motor1,'xdata',erle.Xtemp+erle.X,'ydata',+(erle.Ytemp+erle.Y),'zdata',-(-erle.Ztemp-erle.Z));

[erle.Xtemp,erle.Ytemp,erle.Ztemp] = rotateBFtoGF(erle.Motor2X,erle.Motor2Y,erle.Motor2Z,roll,pitch,yaw);
set(erle.Motor2,'xdata',erle.Xtemp+erle.X,'ydata',+(erle.Ytemp+erle.Y),'zdata',-(-erle.Ztemp-erle.Z));

[erle.Xtemp,erle.Ytemp,erle.Ztemp] = rotateBFtoGF(erle.Motor3X,erle.Motor3Y,erle.Motor3Z,roll,pitch,yaw);
set(erle.Motor3,'xdata',erle.Xtemp+erle.X,'ydata',+(erle.Ytemp+erle.Y),'zdata',-(-erle.Ztemp-erle.Z));
